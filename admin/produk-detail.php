<?php
    ...
    $query = mysqli_query($con, "SELECT a.*, b.jk AS nama_kategori FROM produk a JOIN kategori b ON a. kategori_id=b.id WHERE a.id='$id'");
...
<body>
    ...
    <div class="container mt-5">
            ...
            <div class="col-12 col-md-6 mb-5">
                ...
                <div>
                    ...
                    <select name="kategori" id="kategori" class="form-control" required>
                        ...
                        ?>
                            <option value="<?php echo $dataKategori['id']; ?>"><?php echo $dataKategori['jk']; ?></option>
                        <?php
                            }
                        ?>
                    </select>
                ...
                <div>
                    <label for="currentFoto">Foto Produk Ini</label>
            ...
            ?>
                            <div class="alert alert-warning mt-3" role="alert">
                                File Wajib bertipe jpg png atau jpeg
                            </div>
            <?php                        
                                }
                                else{
