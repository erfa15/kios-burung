<?php
    ...
    $query = mysqli_query($con, "SELECT a.*, b.jk AS jenis_kategori FROM produk a JOIN kategori b ON a. kategori_id=b.id");
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select name="kategori" id="kategori" class="form-control" required>
                        ...
                        ?>
                            <option value="<?php echo $data['id']; ?>"><?php echo $data['jk']; ?></option>
                        <?php
                            }
                        ?>
                    </select>
