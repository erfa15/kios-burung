<?php
    ...
    //get produk by kategori
        ...
        $queryGetKategoriId = mysqli_query($con, "SELECT id FROM kategori WHERE jk='$_GET[kategori]'");
        ...
        <div class="row">
            <div class="col-lg-3 mb-5">
                ...
                <ul class="list-group">
                    ...
                    <a class="no-decoration" href="produk.php?kategori=<?php echo $kategori['jk']; ?>"> 
                        <li class="list-group-item"><?php echo $kategori['jk']; ?></li>
                    </a>
                    <?php } ?>
                </ul>
            </div>
